...
PROFILE_RULES = {
    "android-container-host-v1": [
        ...
        ConfigRule("CFS_BANDWIDTH", "y", "recommended", "Docker CPU quota and period limits"),
        ConfigRule("CGROUP_PERF", "y", "recommended", "cgroup-scoped perf accounting"),
        ...
        ConfigRule("BLK_DEV_THROTTLING", "y", "recommended", "Docker blkio throttle limits"),
        ConfigRule("CGROUP_NET_PRIO", "y", "recommended", "network priority cgroup controller"),
        ConfigRule("CGROUP_NET_CLASSID", "y", "recommended", "network classid cgroup controller"),
        ConfigRule("NET_CLS_CGROUP", "y", "recommended", "tc cgroup classifier"),
        ...
        ConfigRule("UNIX_DIAG", "y", "recommended", "Unix socket diagnostics for container tooling"),
        ConfigRule("FANOTIFY", "y", "recommended", "filesystem notification support used by build and sync tools"),
        ConfigRule("CHECKPOINT_RESTORE", "y", "recommended", "runc and CRIU compatibility surface"),
        ConfigRule("BINFMT_MISC", "y", "recommended", "BuildKit/buildx multi-architecture binfmt support"),
    ],
    "docker-bridge-overlay2": [
        ConfigRule("NAMESPACES", "y", "required", "namespace support base"),
        ConfigRule("UTS_NS", "y", "required", "container hostname isolation"),
